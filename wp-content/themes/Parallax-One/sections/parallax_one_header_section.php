						...
						<div id="intro-section" class="intro-section">
							...
							<?php
								if( !empty($parallax_one_header_title) ){
									echo '<h1 id="intro_section_text_1" class="intro white-text" style="opacity: 0;">'.esc_attr($parallax_one_header_title).'</h1>';
								} elseif ( isset( $wp_customize )   ) {
							...
							<?php
								if( !empty($parallax_one_header_subtitle) ){
									echo '<h5 id="intro_section_text_2" class="white-text" style="opacity: 0;">'.esc_attr($parallax_one_header_subtitle).'</h5>';
								} elseif ( isset( $wp_customize )   ) {
